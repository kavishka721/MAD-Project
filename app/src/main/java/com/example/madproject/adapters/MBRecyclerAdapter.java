...
public class MBRecyclerAdapter extends RecyclerView.Adapter<MBRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        final String MBName = MBList.get(position).getName();
        final int MBPrice = MBList.get(position).getPrice();
        ...
        holder.CPUSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("MBName",MBName);
                intent.putExtra("MBPrice",MBPrice);
                intent.putExtra("MB Object",MBList.get(position));
