...
public class RAMRecyclerAdapter extends RecyclerView.Adapter<RAMRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        final String CPUName = RAMList.get(position).getName();
        final int CPUPrice = RAMList.get(position).getPrice();
        holder.CPUName.setText(RAMList.get(position).getName());
        holder.CPUPrice.setText("Rs "+RAMList.get(position).getPrice().toString());
        holder.CPUSpec.setText("RAM Size : "+RAMList.get(position).getSize().toString()+"GB\nSpeed : "+RAMList.get(position).getSpeed().toString()+"\nType : "+RAMList.get(position).getType()+"MHz"
        ...
        holder.CPUSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("CPU Object",RAMList.get(position));
