...
public class cpuselectionNew extends AppCompatActivity {

    TextView type;
    private DatabaseReference databaseReference;
    private StorageReference mStorageRef;
    private RecyclerView recyclerView;
    private com.example.madproject.classes.CPU CPU = new CPU();
    private ArrayList<com.example.madproject.classes.CPU> CPUList = new ArrayList<>();
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.hasChildren()) {
                    Log.d("Child Count :",""+dataSnapshot.child("CPUs").getChildrenCount());
                    System.out.println("Hello CPUS");
                    for (DataSnapshot postSnapshot : dataSnapshot.child("CPUs").getChildren()){
                        Log.d("KEY VALUE:",postSnapshot.getKey());
                        com.example.madproject.classes.CPU CPU1 = postSnapshot.getValue(com.example.madproject.classes.CPU.class);
...
*/
    ...
    public void initImageList(final ArrayList<String> fileList){
        ...
        for (String file : fileList) {
            mStorageRef.child("CPU Images/" + file).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
                public void onSuccess(Uri uri) {
                    // Got the download URL for 'users/me/profile.png'
